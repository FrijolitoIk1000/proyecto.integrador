...
<body>
  ...
  <section id="quiz">
    <div class="wrapper bg-white rounded">
      <div class="content">
        <p class="text-justify h5 pb-2 font-weight-bold">¿Cuál es una fuente de información importante para identificar servicios y sistemas durante una prueba de penetración?</p>
        <div class="options py-3">
          <label class="rounded p-2 option">
            <span class="cajon">a) Bases de datos de exploits.</span>
            <input type="radio" name="radio" onclick="showNegativeFeedback(); disableOptions(); enableButton()">
            <span class="crossmark"></span>
          </label>
          <label class="rounded p-2 option">
            <span class="cajon">b) Redes sociales.</span>
            <input type="radio" name="radio" onclick="showNegativeFeedback(); disableOptions(); enableButton()">
            <span class="crossmark"></span>
          </label>
          <label class="rounded p-2 option">
            <span class="cajon">c) Sitios web de noticias.</span>
            <input type="radio" name="radio" onclick="showNegativeFeedback(); disableOptions(); enableButton()">
            <span class="crossmark"></span>
          </label>
          <label class="rounded p-2 option" onclick="showPositiveFeedback(); disableOptions(); enableButton()">
            <span class="cajon">d) Escaneo de puertos.</span>
  ...
  <script>
    ...
    function redirectToNextPage() {
      window.location.href = "curso100.php?id_usuario=<?php echo $id_usuario; ?>"; // Reemplaza "nueva_pagina.php" con la URL del archivo PHP al que deseas redirigir
    }
    ...
    function redirectToNextPage() {
      ...
      if (feedbackStyle === "block") {
        ...
        var id_usuario = "<?php echo $id_usuario; ?>";
        saveVariablesInDatabase(80, id_usuario);
        window.location.href = "curso80.php?id_usuario=" + id_usuario;
      }
    }
