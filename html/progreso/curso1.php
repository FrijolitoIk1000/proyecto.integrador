...
<body>
    ...
    <div class="wrapper bg-white rounded">
      <div class="content">
        <p class="text-justify h5 pb-2 font-weight-bold">¿Cuál es el objetivo principal de la fase de recopilación
          de información en una prueba de penetración?</p>
        <div class="options py-3">
          <label class="rounded p-2 option">
            a) Identificar vulnerabilidades en sistemas.
  ...
  <script>
    ...
    function redirectToNextPage() {
      ...
      if (feedbackStyle === "block") {
        ...
        var id_usuario = "<?php echo $id_usuario; ?>";
        saveVariablesInDatabase(20, id_usuario);
        window.location.href = "curso20.php?id_usuario=" + id_usuario;
      }
    }
