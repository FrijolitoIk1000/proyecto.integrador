...
<body>
  ...
  <section id="quiz">
    <div class="wrapper bg-white rounded">
      <div class="content">
        <p class="text-justify h5 pb-2 font-weight-bold">¿Cuál es el siguiente paso después de identificar servicios y sistemas durante una prueba de penetración?</p>
        <div class="options py-3">
          <label class="rounded p-2 option">
            <span class="cajon">a) Realizar un análisis de riesgos.</span>
            <input type="radio" name="radio" onclick="showNegativeFeedback(); disableOptions(); enableButton()">
            <span class="crossmark"></span>
          </label>
          <label class="rounded p-2 option">
            <span class="cajon">b) Realizar pruebas de explotación.</span>
            <input type="radio" name="radio" onclick="showNegativeFeedback(); disableOptions(); enableButton()">
            <span class="crossmark"></span>
          </label>
          <label class="rounded p-2 option">
            <span class="cajon">c) Documentar los hallazgos.</span>
            <input type="radio" name="radio" onclick="showNegativeFeedback(); disableOptions(); enableButton()">
            <span class="crossmark"></span>
          </label>
          <label class="rounded p-2 option" onclick="showPositiveFeedback(); disableOptions(); enableButton()">
            <span class="cajon">d) Realizar un escaneo de vulnerabilidades.</span>
      ...
      <input id="next-question-btn" type="submit" value="Fin de la Prueba" class="mx-sm-0 mx-1" disabled>
    </div>
  </section>
  ...
  <script>
    ...
    function redirectToNextPage() {
      window.location.href = "../panel.php"; // Reemplaza "nueva_pagina.php" con la URL del archivo PHP al que deseas redirigir
    }
    ...
    function redirectToNextPage() {
      ...
      if (feedbackStyle === "block") {
        ...
        var id_usuario = "<?php echo $id_usuario; ?>";
        saveVariablesInDatabase(100, id_usuario);
        window.location.href = "progreso_academico.php?id_usuario=<?php echo $id_usuario; ?>";
      }
    }
