  ...
  <script>
    ...
    function redirectToNextPage() {
      ...
      if (feedbackStyle === "block") {
        ...
        var id_usuario = "<?php echo $id_usuario; ?>";
        saveVariablesInDatabase(40, id_usuario);
        window.location.href = "curso40.php?id_usuario=" + id_usuario;
      }
    }
